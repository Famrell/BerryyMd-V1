...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Berryll Bot', body: wm, sourceUrl: 'https://chat.whatsapp.com/KAHbnN7sCkrGghoVK9NjPX', thumbnail: data }}, options })
    }
